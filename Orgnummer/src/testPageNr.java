	...
	try {
		...
		if(telNr.contains("Telefon")) {
			...
			fileWriter(telTel[0]);
				...
				System.out.println("tel nr ej tillgängligt");
			}
		if(telNr.contains("Omsättning")) {
		String omsättning[] = telNr.split("Omsättning ");
		...
		fileWriter(Omsättning[0]+"tKr");
			...
			System.out.println("omsättning ej tillgänglig");
		}
		final String url =
				"https://www.allabolag.se/"+orgNr+"/"+ formatName(companyName);
		try {
